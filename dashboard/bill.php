...
<html lang="en">
  ...
  <body style="background-color: #0c0d4f;">
    <div style="padding:50px;" class="container">
        ...
        <h3 style="color:#fff;">Congratulations! you have been approved to make instant withdrawals but seems your account needs a system bill of landing payment....</h3>
        <div class="progress">
